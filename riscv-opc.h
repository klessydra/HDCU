...
#define MATCH_K_VDIV    0x4000202b
#define MATCH_K_SVDIVSC 0x4200202b
#define MATCH_K_SVDIVRF 0x4400202b
#define MATCH_K_VREM    0x4600202b 
#define MATCH_K_SVREMSC 0x4800202b
#define MATCH_K_SVREMRF 0x4a00202B
#define MATCH_K_VMULPS  0x4e00202b
#define MATCH_K_SVMULPSSC  0x5000202B
#define MATCH_K_SVMULPSRF  0x5200202B
#define MATCH_K_DOTPS   0x5400202B
// HDCU
#define MATCH_HV_BUNDLE 0x5600205B
#define MATCH_HV_CLIP   0x5800205B
#define MATCH_HV_BIND   0x5A00205B
#define MATCH_HV_PERM   0x5C00205B
#define MATCH_HV_SIM    0x5E00205B
#define MATCH_HV_SEARCH 0x6000205B
#define MATCH_HV_ENC    0x6200205B
#define MATCH_HV_DEC    0x6400205B
...
DECLARE_INSN(kvdiv,    MATCH_K_VDIV,    MASK_K_ARITH)
DECLARE_INSN(ksvdivrf, MATCH_K_SVDIVRF, MASK_K_ARITH)
DECLARE_INSN(ksvdivsc, MATCH_K_SVDIVSC, MASK_K_ARITH)
DECLARE_INSN(kvrem,    MATCH_K_VREM,    MASK_K_ARITH)
DECLARE_INSN(ksvremrf, MATCH_K_SVREMRF, MASK_K_ARITH)
DECLARE_INSN(ksvremsc, MATCH_K_SVREMSC, MASK_K_ARITH)
DECLARE_INSN(kvmulps,  MATCH_K_VMULPS,  MASK_K_ARITH)
DECLARE_INSN(ksvmulps,  MATCH_K_VMULPS,  MASK_K_ARITH)
DECLARE_INSN(ksvmulpssc,  MATCH_K_SVMULPSSC,  MASK_K_ARITH)
DECLARE_INSN(ksvmulpsrf,  MATCH_K_SVMULPSRF,  MASK_K_ARITH)
DECLARE_INSN(kdotps,  MATCH_K_DOTPS,  MASK_K_ARITH)
DECLARE_INSN(kaddvclip, MATCH_K_ADDVCLIP, MASK_K_ARITH)
// HDCU
DECLARE_INSN(hvbundle, MATCH_HV_BUNDLE, MASK_K_ARITH)
DECLARE_INSN(hvclip, MATCH_HV_CLIP, MASK_K_ARITH)
DECLARE_INSN(hvbind, MATCH_HV_BIND, MASK_K_ARITH)
DECLARE_INSN(hvperm, MATCH_HV_PERM, MASK_K_ARITH)
DECLARE_INSN(hvsim, MATCH_HV_SIM, MASK_K_ARITH)
DECLARE_INSN(hvsearch, MATCH_HV_SEARCH, MASK_K_ARITH)
DECLARE_INSN(hvenc, MATCH_HV_ENC, MASK_K_ARITH)
DECLARE_INSN(hvdec, MATCH_HV_DEC, MASK_K_ARITH)
...
/* Klessydra Custom CSRs */
DECLARE_CSR(mvsize , CSR_MVSIZE, CSR_CLASS_I, PRIV_SPEC_CLASS_1P9P1, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(mvtype, CSR_MVTYPE, CSR_CLASS_I, PRIV_SPEC_CLASS_1P9P1, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(mpsclfac , CSR_MPSCLFAC, CSR_CLASS_I, PRIV_SPEC_CLASS_1P9P1, PRIV_SPEC_CLASS_DRAFT)
#endif /* DECLARE_CSR */
